/*
 * QR matrix core derived from Kazuhiko Arase's QR Code Generator.
...
(function (root) {
  ...
  function localRequire(id) {
    ...
    if (!factories[id]) throw new Error("Unknown QR module: " + id);
  ...
  root.IMPROMPT_QR_CORE = Object.freeze({
    QRCode: localRequire("./index"),
    ErrorCorrectLevel: localRequire("./QRErrorCorrectLevel")
  });
