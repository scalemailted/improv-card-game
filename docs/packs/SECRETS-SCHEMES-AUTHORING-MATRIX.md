...
**Status:** Complete selected matrix; live playtest pending

Every formal Card Bible subtheme receives exactly one selected Pack 6 card. This preserves the ten-pack architecture while interpreting each slot through concealment, investigation, recruitment, misdirection, confession, or plans under pressure.

## Stances

| ID | Category | Subtheme | Card | Instruction | Difficulty | Intensity | Tone |
|---|---|---|---|---|---|---|---|
| S121 | Status & Authority | Command Presence | **The Keeper of Secrets** | Carry yourself as the person entrusted with what others cannot know, letting selective disclosure determine what everyone is allowed to discuss. | Intermediate | Medium | Grounded |
| S122 | Status & Authority | Precarious Authority | **Authority by Bluff** | Project control through confident half-answers while guarding the possibility that one direct question could expose how little you actually know. | Advanced | High | Grounded |
| S123 | Status & Authority | Professional Expertise | **Professional Suspicion** | Treat inconsistencies, evasions, and missing details as evidence your trained eye should investigate before anyone proceeds. | Beginner | Medium | Grounded |
| S124 | Status & Authority | Belonging & Legitimacy | **Cleared to Know** | Treat access to private information as proof that you belong, and exclusion from any detail as a challenge to your legitimacy. | Intermediate | High | Grounded |
| S125 | Status & Authority | Mentorship & Rank | **The Initiated One** | Treat others as recent initiates, revealing rules and information in carefully measured doses that preserve your seniority. | Intermediate | Medium | Grounded |
| S126 | Status & Authority | Hidden Leverage | **Information Is Leverage** | Remain outwardly cooperative while controlling one useful fact, releasing only enough of it to shape each decision. | Advanced | Medium | Grounded |
...
| S134 | Emotional Assumptions | Identity & Nostalgia | **Before We Knew** | Return emotionally to the time before a difficult truth changed what you could believe, trust, or say openly. | Beginner | High | Grounded |
| S135 | Emotional Assumptions | Fear & Insecurity | **Everyone Knows Something** | Interpret private conversations, careful wording, and unexplained pauses as signs that important information is being kept from you. | Beginner | High | Heightened |
| S136 | Emotional Assumptions | Care & Control | **Protection Through Silence** | Protect others by withholding details, redirecting questions, and managing timing because you trust your own judgment about when the truth should surface. | Intermediate | High | Grounded |
| S137 | Emotional Assumptions | Approval & Belonging | **Trusted with This** | Treat being confided in as proof of closeness, and guard that privileged role whenever information begins spreading. | Beginner | Medium | Grounded |
| S138 | Emotional Assumptions | Pride & Validation | **I Figured It Out** | Create opportunities to reveal that you noticed the pattern first while pretending recognition matters less than solving the problem. | Intermediate | Medium | Heightened |
| S139 | Worldview & Absurdity | Ritual & Tradition | **The Secrecy Protocol** | Treat concealment as a precise ritual with passwords, signals, approved phrases, and severe consequences for careless improvisation. | Intermediate | Medium | Absurd |
| S140 | Worldview & Absurdity | Crisis & Catastrophe | **The Leak Is Spreading** | Interpret every new question or coincidence as evidence that concealed information is escaping faster than it can be contained. | Beginner | High | Heightened |
...
| ID | Category | Subtheme | Card | Instruction | Difficulty | Intensity | Tone |
|---|---|---|---|---|---|---|---|
| D121 | Direct Objectives | Secure Help | **Help Me Keep This Quiet** | Get someone to help contain a secret without first revealing its full risk or purpose. | Beginner | Medium | Grounded |
| D122 | Direct Objectives | Prevent Departure | **Not Until You Explain** | Keep someone present until they account for one contradiction, omission, or suspicious change in their story. | Beginner | High | Grounded |
| D123 | Direct Objectives | Obtain an Apology | **Apologize for the Lie** | Make someone acknowledge that the concealment or misdirection mattered, even if the underlying choice was defensible. | Beginner | High | Grounded |
...
| D140 | Repeatable Behaviors | Positive Reframing | **The Plan Gets Better** | Celebrate every setback as proof that the scheme is becoming more sophisticated, selective, or impossible to detect. | Beginner | Medium | Heightened |
| D141 | Repeatable Behaviors | Emotional Contradiction | **Warmly Withholding** | Remain open, caring, and reassuring while revealing less with every new question. | Intermediate | High | Grounded |
| D142 | Repeatable Behaviors | Transactional Framing | **Secrets Have Value** | Price every fact, introduction, warning, and confession as something that must be traded for equal value. | Intermediate | Medium | Grounded |
| D143 | Repeatable Behaviors | Self-Serving Agreement | **I Told You Enough** | Agree to be honest while repeatedly narrowing what honesty requires and which details count. | Beginner | Medium | Grounded |
| D144 | Repeatable Behaviors | Pattern Escalation | **The Conspiracy Expands** | Use every denial, coincidence, and missing detail as proof that more people and higher stakes are involved. | Beginner | High | Heightened |
...
Every category contains exactly one selected Secrets & Schemes card in each formal subtheme. The matrix deepens the complete taxonomy rather than limiting the pack to Secrets & Avoidance Drives.
