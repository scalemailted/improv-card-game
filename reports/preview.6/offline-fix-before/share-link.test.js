...
assert.ok(serviceWorker.includes(JSON.stringify("./assets/improv-card-game-qr.png?v=" + releaseVersion)), "QR image must be precached under the exact current release version");
