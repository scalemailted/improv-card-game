...
# Appendix F — Emotional Pressure implementation

Emotional Pressure is the fourth expansion authored under this Bible. It is active in Imprompt v0.12.0 with internal status `playtest`.

- Pack brief: `docs/packs/EMOTIONAL-PRESSURE-PACK-BRIEF.md`
- Authoring matrix: `docs/packs/EMOTIONAL-PRESSURE-AUTHORING-MATRIX.md`
- Candidate pool: `docs/packs/EMOTIONAL-PRESSURE-CANDIDATE-POOL.md`
- Machine-readable candidates: `cards/candidates/emotional-pressure-candidate-pool.json`
- Runtime module: `cards/emotional-pressure.js`

The pack provides one S97–S120 or D97–D120 card in every formal subtheme. It adds six coach roles—Griever, Hope Keeper, Reassurance Seeker, Shame Bearer, Emotional Buffer, and Comforter—and fifteen emotional-analysis motifs without changing the visible seven-category system.

With Core Foundations, Everyday Friction, Power Games, Relationship Knots, and Emotional Pressure, the active library now contains 120 Stances and 120 Drives, or 240 total cards. Emotional Pressure remains subject to independent blind reads and repeated live troupe playtesting before final publication.

# Appendix G — Secrets & Schemes implementation

Secrets & Schemes is the fifth expansion authored under this Bible. It is active in Imprompt v0.13.0 with internal status `playtest`.

- Pack brief: `docs/packs/SECRETS-SCHEMES-PACK-BRIEF.md`
- Authoring matrix: `docs/packs/SECRETS-SCHEMES-AUTHORING-MATRIX.md`
- Candidate pool: `docs/packs/SECRETS-SCHEMES-CANDIDATE-POOL.md`
- Machine-readable candidates: `cards/candidates/secrets-schemes-candidate-pool.json`
- Runtime module: `cards/secrets-schemes.js`
...
# Appendix I — Rules, Rituals & Institutions implementation

Rules, Rituals & Institutions is the seventh expansion authored under this Bible. It is active in Imprompt v0.15.0 with internal status `playtest`.

- Pack brief: `docs/packs/RULES-RITUALS-INSTITUTIONS-PACK-BRIEF.md`
- Authoring matrix: `docs/packs/RULES-RITUALS-INSTITUTIONS-AUTHORING-MATRIX.md`
- Candidate pool: `docs/packs/RULES-RITUALS-INSTITUTIONS-CANDIDATE-POOL.md`
- Machine-readable candidates: `cards/candidates/rules-rituals-institutions-candidate-pool.json`
- Runtime module: `cards/rules-rituals-institutions.js`

The pack provides one S169–S192 or D169–D192 card in every formal subtheme. It adds six coach roles—Administrator, Compliance Keeper, Interpreter, Archivist, Traditionalist, and Exception Seeker—and eighteen system-and-tradition motifs without changing the visible seven-category interface.
