"use strict";
const CACHE_NAME = "imprompt-v0.24.0";
const BASE_URL = new URL("./", self.location.href);
const PRECACHE_PATHS = [
  "./",
  "./index.html",
  "./styles.css?v=0.24.0",
  "./card-bible.js?v=0.24.0",
  "./cards/core-foundations.js?v=0.24.0",
  "./cards/everyday-friction.js?v=0.24.0",
  "./cards/power-games.js?v=0.24.0",
  "./cards/relationship-knots.js?v=0.24.0",
  "./cards/emotional-pressure.js?v=0.24.0",
  "./cards/secrets-schemes.js?v=0.24.0",
  "./cards/absurd-commitment.js?v=0.24.0",
  "./cards/rules-rituals-institutions.js?v=0.24.0",
  "./cards/competition-consequences.js?v=0.24.0",
  "./cards/advanced-scene-engines.js?v=0.24.0",
  "./cards.js?v=0.24.0",
  "./hint-bible.js?v=0.24.0",
  "./exercises.js?v=0.24.0",
  "./deck-engine.js?v=0.24.0",
  "./vendor/qrcode-core.js?v=0.24.0",
  "./examples/manifest.js?v=0.24.0",
  "./examples/library-client.js?v=0.24.0",
  "./app.js?v=0.24.0",
  "./examples/library-worker.js?v=0.24.0",
  "./manifest.webmanifest?v=0.24.0",
  "./assets/improv-card-game-qr.png?v=0.24.0",
  "./icons/icon.svg?v=0.24.0",
  "./icons/icon-192.png?v=0.24.0",
  "./icons/icon-512.png?v=0.24.0",
  "./examples/data/singles.d39aadaf1bfd.json.gz",
  "./examples/data/singles.d39aadaf1bfd.json"
];
