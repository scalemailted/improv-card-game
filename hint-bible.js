  ...
  const policies = [
    {
      ...
      description: "Single-card nudges and complete two-card combination guidance are available immediately.",
      allowsSingle: true,
    ...
    },
    {
      ...
      description: "Players receive one concise behavioral nudge without the deeper heightening or next-beat guidance.",
      allowsSingle: true,
      allowsCombination: true,
      allowsDepth: false,
      requiresUnlock: false
